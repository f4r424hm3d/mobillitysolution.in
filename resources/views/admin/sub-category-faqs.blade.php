            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a
                    href="{{ url('/admin/product-sub-categories') }}">{{ $productSubCategory->sub_category_name }}</a>
                </li>
              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-InputField type="text" label="Enter Question" name="question" id="question" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
