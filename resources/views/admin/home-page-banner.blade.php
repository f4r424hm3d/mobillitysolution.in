              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 mb-3">
                    ...
                    <span id="heading-err" class="text-danger errSpan"></span>
                  </div>
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-TextareaField type="text" label="Enter shortnote" name="shortnote" id="shortnote"
                      :ft="$ft" :sd="$sd">
                    </x-TextareaField>
                    <span id="shortnote-err" class="text-danger errSpan"></span>
                  </div>
                  <div class="col-md-4 col-sm-12 mb-3">
                    <x-InputField type="file" label="Upload Banner" name="banner" id="banner" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                    <span id="banner-err" class="text-danger errSpan"></span>
                  </div>
                </div>
                @if ($ft == ' add')
