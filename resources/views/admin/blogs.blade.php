            ...
            <form id="{{ $ft=='add' ? 'dataForm' : 'editForm' }}" {{ $ft=='edit' ?'action='.$url:'' }} class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-InputField type="text" label="Enter Title" name="title" id="title" :ft="$ft" :sd="$sd">
                  </x-InputField>
                  <span id="title-err" class="text-danger errSpan"></span>
                </div>
                <div class="col-md-4 col-sm-12 mb-3">
                  <x-SelectField type="text" label="Select Category" name="category_id" id="category_id" :ft="$ft" :sd="$sd" :list="$blog_categories" savev="id" showv="category_name">
                  </x-SelectField>
                  <span id="category_id-err" class="text-danger errSpan"></span>
                </div>
                <div class="col-md-4 col-sm-12 mb-3">
                  <x-SelectField type="text" label="Select Author" name="author_id" id="author_id" :ft="$ft" :sd="$sd" :list="$authors" savev="id" showv="author_name">
                  </x-SelectField>
                  <span id="author_id-err" class="text-danger errSpan"></span>
                </div>
                <div class="col-md-4 col-sm-12 mb-3">
                  <x-InputField type="file" label="Upload Thumbnail" name="thumbnail" id="thumbnail" :ft="$ft" :sd="$sd">
                  </x-InputField>
                ...
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-TextareaField label="Enter Description" name="description" id="description" :ft="$ft" :sd="$sd">
                  </x-TextareaField>
