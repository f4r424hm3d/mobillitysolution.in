...
@section('main-section')
  <div class="page-content">
    <div class="container-fluid">
      ...
      <div class="row {{ request()->segment(3) == 'add' || request()->segment(3) == 'update' ? '' : 'hide-this' }}">
        <div class="col-xl-12">
          <div class="card">
              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-InputField type="text" label="Page Name" name="url" id="url" :ft="$ft"
                      :sd="$sd" disabled="{{ $ft == 'edit' ? 'disabled' : '' }}">
                    </x-InputField>
                  </div>
                </div>
                <hr>
