            ...
            <div class="card-body {{ $ft == 'edit' ? '' : 'hide-this' }}" id="tblCDiv">
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Branch" name="branch" id="branch" :ft="$ft"
                      :sd="$sd"></x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Experience" name="experience_short" id="experience_short"
                      :ft="$ft" :sd="$sd"></x-InputField>
                  </div>
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-InputField type="text" label="Language (Ex: Hindi,English,Franch)" name="languages"
                      id="languages" :ft="$ft" :sd="$sd"></x-InputField>
                  </div>
