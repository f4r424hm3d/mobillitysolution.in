            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="topnav-more">
                  <a href="{{ aurl('product-categories') }}" class="dropdown-item">Category</a>
                  <a href="{{ aurl('product-sub-categories') }}" class="dropdown-item">Sub Category</a>
                  <a href="{{ aurl('products') }}" class="dropdown-item">Products</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button">
