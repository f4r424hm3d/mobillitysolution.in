...
.popup-image {
  ...
  max-height: 80%; /* Ensure it does not overflow the viewport */
}
  ...
  <div class="container g-0">
    <div class="row">
     ...
     <div class="col-lg-6">
      ...
      <img src="https://www.mobilitysolution.in/uploads/products/img-20240731-123812_1722506741.jpg" alt="Main Image" class="main-image" id="mainImage">
      <button class="btn btn-next" onclick="changeImage(1)">&#10095;</button>
      <div class="thumbnail-container">
        <img src="https://www.mobilitysolution.in/uploads/products/img-20240731-123812_1722506741.jpg" alt="Thumbnail 1" class="thumbnail" onclick="selectImage(0)">
        <img src="https://www.mobilitysolution.in/web/assets/imgs/products/home/1.jpg" alt="Thumbnail 2" class="thumbnail" onclick="selectImage(1)">
        <img src="https://www.mobilitysolution.in/uploads/products/img-20240731-123812_1722506741.jpg" class="thumbnail" onclick="selectImage(2)">
      </div>
    </div>
  ...
  <div class="container-fluid">
    ...
    <div class="gallery">
      <div class="gallery-item-wrapper">
        <img class="gallery-item" src="https://www.mobilitysolution.in/uploads/products/adhesive-prosthetic-ear-right_1722507340.jpg" alt="Gallery Image">
      </div>
      <div class="gallery-item-wrapper">
        <img class="gallery-item" src="https://www.mobilitysolution.in/web/assets/imgs/products/home/1.jpg" alt="Gallery Image">
      </div>
      <div class="gallery-item-wrapper">
        <img class="gallery-item" src="https://www.mobilitysolution.in/uploads/products/adhesive-prosthetic-ear-right_1722507340.jpg" alt="Gallery Image">
      </div>
