  ...
  <div>
    <div class="container">
      <div class="row">
        ...
        <!--    <span class="widget-title">Top Colleges</span>-->
        <!--    <ul class="footer-menu">-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> M.B.A</a></li>-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> B.TECH/B.E</a></li>-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> MCA</a></li>-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> BCA</a></li>-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> M.TECH</a></li>-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> MA</a></li>-->
        <!--      <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> BA</a></li>-->
        <!--    </ul>-->
        <!--  </div>-->
        <!--</div>-->
        ...
        <div class="col-lg-2 col-md-3">
          <div class="footer-widget">
            ...
            <ul class="footer-menu">
              <li><a href="{{ url('/') }}/canada"><i class="ti-arrow-right"></i> CANADA</a></li>
              <li><a href="{{ url('/') }}/usa"><i class="ti-arrow-right"></i> USA</a></li>
              <li><a href="{{ url('/') }}/uk"><i class="ti-arrow-right"></i> UK</a></li>
              <li><a href="{{ url('/') }}/"><i class="ti-arrow-right"></i> UAE</a></li>
              <li><a href="{{ url('/') }}/australia"><i class="ti-arrow-right"></i> AUSTRALIA</a></li>
              <li><a href="{{ url('/') }}/germany"><i class="ti-arrow-right"></i> GERMANY</a></li>
              <li><a href="{{ url('/') }}/cyprus"><i class="ti-arrow-right"></i> Cyprus</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-md-3">
          <div class="footer-widget">
            ...
            <ul class="footer-menu">
              <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> IRELAND</a></li>
              <li><a href="{{ url('/') }}/new-zealand"><i class="ti-arrow-right"></i> NEW ZEALAND</a></li>
              <li><a href="{{ url('/') }}/"><i class="ti-arrow-right"></i> HONG KONG</a></li>
              <li><a href="{{ url('/') }}/singapore"><i class="ti-arrow-right"></i> SINGAPORE</a></li>
              <li><a href="{{ url('/') }}/malaysia"><i class="ti-arrow-right"></i> MALAYSIA</a></li>
              <li><a href="{{ url('/') }}/netherlands"><i class="ti-arrow-right"></i> NETHERLANDS</a></li>
              <li><a href="{{ url('/') }}/hungary"><i class="ti-arrow-right"></i> Hungary</a></li>
            </ul>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-6">
          <p class="mb-0">© 2024 Mobility Solution</p>
        </div>
...
<div class="jsx-66a23b37ae4ff4a1 bottomLeadTickerContainer  bottom-btn">
  <button class="jsx-66a23b37ae4ff4a1 bottomLeadTickerBtn">
    <span class="jsx-66a23b37ae4ff4a1"><a href="{{ url('enquiry') }}" target="blank">Get a
  ...
  <div class="wa-container">
    ...
    <div class="content">
      ...
      <a class="country-box" target="_blank"
        href="https://api.whatsapp.com/send?phone=919818560331&text=Hello there!! I want to get counseling by experts. Want to know more information about Study Abroad Consultants in India - Mobility Solution">
        <div class="row align-items-center">
      ...
      <a class="country-box" target="_blank"
        href="https://api.whatsapp.com/send?phone=919342914452&text=Hello there!! I want to get counseling by experts. Want to know more information about Study Abroad Consultants in India - Mobility Solution">
        <div class="row align-items-center">
          <div class="col-2 pr-0"><img data-src="https://www.britannicaoverseas.com/front/assets/img/flag-india.png"
              alt="indian flag" class="img-fluid"></div>
          <div class="col-8 pr0">
      ...
      <a class="country-box" target="_blank"
        href="https://api.whatsapp.com/send?phone=601123828704&text=Hello there!! I want to get counseling from experts. Want to know more information about Study Abroad Consultants in India - Mobility Solution">
        <div class="row align-items-center">
