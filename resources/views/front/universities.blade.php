                      ...
                      <div class="dashboard_single_course_caption col-lg-11 col-12">
                        <div class="dashboard_single_course_head">
                          <div class="dashboard_single_course_head_flex mt-0">
                            <h4 class="dashboard_course_title mb-1" style="font-size:20px"><a
                                href="{{ url($row->getUniversity->slug) }}">{{ $row->getUniversity->name }}</a></h4>
                            <div class="row">
                              <div class="col-md-12"><i class="ti-location-pin"></i> {{ $row->getUniversity->state }},
                                {{ $row->getUniversity->country }}</div>
                            </div>
                          </div>
                          <div class="dc_head_right">
                            <div class="dropdown">
                              <a href="{{ url('enquiry') }}" class="btn btn-modern2 univ-btn reviews-btn">Apply Now</a>
                            </div>
                          </div>
                        </div>
                      </div>
