        ...
        <div class="col-lg-6 col-md-6 col-12">
          ...
          <div class="no-gutters position-relative log_rads">
            <div class="log_wraps">
              ...
              <div class="form-group"><a href="student-profile.html" class="btn btn-theme-2 rounded w-100">Submit</a></div>

              <div class="form-group text-center mb-0">
                Are you a already member?&nbsp;&nbsp; <a href="https://studyabroad.britannicaoverseas.com/sign-in" class="theme-cl">Sign In</a>
              </div>
