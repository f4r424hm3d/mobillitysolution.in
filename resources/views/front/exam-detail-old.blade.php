          ...
          <div class="edu_cat_2">
            <div class="d-flex align-items-center">
              <div class="edu_cat_icons border">
                <span class="pic-main"><img
                    data-src="https://studyabroad.britannicaoverseas.com/front/assets/img/usa-flag.jpg" class="img-fluid"
        ...
        <div class="col-lg-4">
          <div class="edu_cat_2">
            <div class="d-flex align-items-center">
              <div class="edu_cat_icons border">
                <span class="pic-main"><img
                    src="https://studyabroad.britannicaoverseas.com/front/assets/img/canada-flag.jpg" class="img-fluid"
                    alt="Country Flag"></span>
              </div>
              <div class="edu_cat_data">
        ...
        <div class="col-lg-4">
          <div class="edu_cat_2">
            <div class="d-flex align-items-center">
              <div class="edu_cat_icons border">
                <span class="pic-main"><img
                    src="https://studyabroad.britannicaoverseas.com/front/assets/img/australia-flag.jpg"
        ...
        <div class="col-lg-4">
          <div class="edu_cat_2">
            <div class="d-flex align-items-center">
              <div class="edu_cat_icons border">
                <span class="pic-main"><img
                    data-src="https://studyabroad.britannicaoverseas.com/front/assets/img/uk-flag.jpg" class="img-fluid"
                    alt="Country Flag"></span>
              </div>
              <div class="edu_cat_data">
        ...
        <div class="col-lg-4">
          <div class="edu_cat_2">
            <div class="d-flex align-items-center">
              <div class="edu_cat_icons border">
                <span class="pic-main"><img
                    src="https://studyabroad.britannicaoverseas.com/front/assets/img/ireland-flag.jpg" class="img-fluid"
                    alt="Country Flag"></span>
              </div>
              <div class="edu_cat_data">
        ...
        <div class="col-lg-4">
          <div class="edu_cat_2">
            <div class="d-flex align-items-center">
              <div class="edu_cat_icons border">
                <span class="pic-main"><img
                    src="https://studyabroad.britannicaoverseas.com/front/assets/img/newzealand-flag.jpg"
                    class="img-fluid" alt="Country Flag"></span>
              </div>
              <div class="edu_cat_data">
