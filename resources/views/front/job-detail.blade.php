              ...
              <div class="row align-items-center mb-3">
                <div class="col-8">
                  <div class="new-author">
                    <div class="img-div">
                      <img
                        data-src="https://studyabroad.britannicaoverseas.com/uploads/users/britannica-author_1691754396.jpg"
      ...
      <div class="row mt-3 arrow_slide five_slide arrow_middle _wrk_prc_wrap active">
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/c1_1693905223.jpg"
              class="img-fluid" alt="UK">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                UK</h4>
              <a href="https://studyabroad.britannicaoverseas.com/uk" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        </div>
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/canada_1694003866.jpg"
              class="img-fluid" alt="Canada">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                Canada</h4>
              <a href="https://studyabroad.britannicaoverseas.com/canada" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/australia_1694003416.jpg"
              class="img-fluid" alt="Australia">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                Australia</h4>
              <a href="https://studyabroad.britannicaoverseas.com/australia" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/germany_1694003453.jpg"
              class="img-fluid" alt="Germany">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                Germany</h4>
              <a href="https://studyabroad.britannicaoverseas.com/germany" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/cyprus_1694003541.jpg"
              class="img-fluid" alt="Cyprus">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                Cyprus</h4>
              <a href="https://studyabroad.britannicaoverseas.com/cyprus" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/netherlands_1694003580.jpg"
              class="img-fluid" alt="Netherlands">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                Netherlands</h4>
              <a href="https://studyabroad.britannicaoverseas.com/netherlands" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/singapore_1694003784.jpg"
              class="img-fluid" alt="Singapore">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                Singapore</h4>
              <a href="https://studyabroad.britannicaoverseas.com/singapore" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/usa_1694003802.jpg"
              class="img-fluid" alt="USA">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                USA</h4>
              <a href="https://studyabroad.britannicaoverseas.com/usa" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/new-zealand_1694003819.jpg"
              class="img-fluid" alt="New Zealand">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                New Zealand</h4>
              <a href="https://studyabroad.britannicaoverseas.com/new-zealand" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
        ...
        <div class="singles_items">
          <div class="card shadow-0 mb-0">
            <img data-src="https://studyabroad.britannicaoverseas.com/uploads/destination/india_1694003915.jpg"
              class="img-fluid" alt="India">
            <div class="card-header bg-light border-0 pl-4 pr-4">
              <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in
                India</h4>
              <a href="https://studyabroad.britannicaoverseas.com/india" class="btn btn_apply w-100"
                style="height:40px">View
                Details</a>
            </div>
          </div>
