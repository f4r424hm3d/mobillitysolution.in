  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem",
        "position": 4,
        "name": "{{ $pageDetail->sub_category_name }}",
        "item": "{{ url($pageDetail->sub_category_slug) }}"
      }]
    }
  </script>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="ed_detail_wrap light">
            <ul class="cources_facts_list">
              ...
              <li class="facts-1">{{ $pageDetail->sub_category_name }}</li>
            </ul>
            <div class="ed_header_caption mb-0">
              <h1 class="ed_title mb-0">{{ $pageDetail->sub_category_name }}</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
          <div class="new-exam-page">
            ...
            <div class="sec-heading">
              <h2>{{ $pageDetail->sub_category_name }}</h2>
            </div>
            ...
            @if ($pageDetail->thumbnail_path != null)
              <img data-src="{{ asset($pageDetail->thumbnail_path) }}" alt="{{ $pageDetail->sub_category_name }}">
            @endif
        ...
        <div class="col-lg-4 col-md-4">
          ...
          @if ($otherSubCategories->count() > 0)
            <div class="single_widgets widget_category">
              <h5 class="title">Other Sub Categories</h5>
              <ul>
                @foreach ($otherSubCategories as $row)
                  <li id="contact">
                    <a href="{{ url($row->category->category_slug . '/' . $row->sub_category_slug) }}">
