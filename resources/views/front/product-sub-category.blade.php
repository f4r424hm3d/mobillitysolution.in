...
<div class="breadcrumb">
    <div class="container">
        <ul class="woocomerce__single-breadcrumb">
            ...
            <li><a href="{{ url($row->getCategory->category_slug) }}">{{ $row->getCategory->category_name }} <i class="fa-solid fa-chevron-right"></i></a></li>
...
<section class="faq__area">
    <div class="container g-0 pt-100 pb-100">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="faq__img"><img src="{{ asset($row->thumbnail_path) }}" alt="{{ $row->sub_category_name }}" data-speed="auto"></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid pt-100">
        <div class="row pb-5">
            <div class="col-lg-12">
                ...
                <p class="mt-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
            </div>
        </div>
            ...
            <div class="portfolio__inner-5 row">
                ...
                <div class="portfolio__item-5 col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <div class="portfolio__content-5">
                        <h3 class="portfolio__title-5 mb-2">{{ $pd->product_name }}</h3>
                        <a href="{{ url($pd->product_slug) }}" class="blog__btn">View Product Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                </div>
                @endforeach
            </div>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo{{ $faq->id }}">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo{{ $faq->id }}" aria-expanded="false" aria-controls="collapseTwo{{ $faq->id }}">{{ $faq->question }}</button>
                                </h2>
                                <div id="collapseTwo{{ $faq->id }}" class="accordion-collapse collapse" aria-labelledby="headingTwo{{ $faq->id }}" data-bs-parent="#accordionExample">
