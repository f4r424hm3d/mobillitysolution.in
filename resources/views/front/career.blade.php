  ...
  <section class="bg-light">
    <div class="container">
      ...
      <div class="sec-heading center">
        <h2>Job Openings in <span class="theme-cl1">Mobility Solution</span></h2>
      </div>
          ...
          <div class="prc_wrap">
            ...
            <div class="prc_wrap-body">
              <div class="contact-info">
                <p>Lead your professional career with Mobility Solution. Drop us a email.</p>

                <div class="cn-info-detail">
                  <div class="cn-info-content">
                    <h4 class="cn-info-title"><i class="ti-email mr-1 theme-cl1"></i> career@mobilitysolution.in
                    </h4>
                  </div>
                </div>
