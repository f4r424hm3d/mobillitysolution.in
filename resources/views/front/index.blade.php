      ...
      <div class="row">
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          <article class="blog__item-3">
            <div class="blog__img-wrapper-3">
              <div class="img-box">
                <img class="image-box__item" src="{{ url('web/') }}/assets/imgs/blog/1.jpg" alt="Blog Thumbnail">
                <img class="image-box__item" src="{{ url('web/') }}/assets/imgs/blog/1.jpg" alt="BLog Thumbnail">
              </div>
            </div>
            <div class="blog__info-3">
              <h4 class="blog__meta">UI Design . 02 May 2019</h4>
              <h5>
                <div class="blog__title-3">How to bring fold to your startup company with Axtra</div>
              </h5>
              <a href="blog-details.html" class="blog__btn">Expolore Now <span><i
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          <article class="blog__item-3">
            <div class="blog__img-wrapper-3">
              <div class="img-box">
                <img class="image-box__item" src="{{ url('web/') }}/assets/imgs/blog/2.jpg" alt="Blog Thumbnail">
                <img class="image-box__item" src="{{ url('web/') }}/assets/imgs/blog/2.jpg" alt="BLog Thumbnail">
              </div>
            </div>
            <div class="blog__info-3">
              <h4 class="blog__meta">UI Design . 02 May 2019</h4>
              <h5>
                <div class="blog__title-3">How to manage a talented and successful design team</div>
              </h5>
              <a href="blog-details.html" class="blog__btn">Expolore Now <span><i
                    class="fa-solid fa-arrow-right"></i></span></a>
            </div>
