  ...
  <div class="image-cover hero_banner hero-inner-2 shadow rlt" data-overlay="7">
    ...
    <div class="container text-center" style="position:absolute">
      <div class="hero-caption mb-2">
        <h1 class="big-header-capt cl_2 mb-0">Mobility Solution Your Gateway to Global Education</h1>
        <p class="text-center">Welcome to Mobility Solution, your trusted partner in realizing your dreams of
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-6 col-sm-12">
          <div class="about-short">
            ...
            <p>Mobility Solution is your gateway to international education on a global stage. With over 8
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            <div class="about-short">
              ...
              <p class="mb-4">At Mobility Solution, we understand the unique needs and challenges faced by
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            <div class="about-short">
              ...
              <p class="mb-4">At Mobility Solution, we take pride in being a bridge between universities
